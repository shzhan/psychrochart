    ...
    def test_custom_style_psychrochart_2(self):
        ...
        custom_style = {
            'chart_params': {
                ...
                'constant_h_step': 5000,
                'constant_humid_label': None,
                'constant_humid_label_include_limits': False,
                'constant_humid_label_step': 0.005,
                'constant_humid_step': 0.0025,
            ...
            'figure': {'figsize': [16, 9],
                       ...
                       'y_axis_ticks': {'color': [0.0, 0.125, 0.376],
                                        ...
                                        'pad': -20},
                       'y_label': None},
            # 'limits': {'range_humidity': [2.5, 17.5],
            'limits': {'range_humidity': [0.0025, 0.02],
                       'range_temp': [15, 35],
                       'step_temp': 0.5,
                       'pressure': 101420},
